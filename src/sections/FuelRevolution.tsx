const FuelRevolution = () => {
  return (
    <div className="flex flex-col gap-6 font-helvetica">
      <p className="text-lg font-revoluti">FUEL THE REVOLUTION</p>
      <p className="font-thin">
        <span className="font-bold">Ownership and Empowerment:</span> Purchasing
      ...
      <p className="font-thin">
        <span className="font-bold">Fueling the Ecosystem:</span> FICCO coins
      ...
      <div className="font-thin">
        <p>
          <span className="font-bold">Access and Rewards:</span>{" "}
